...
class Trainer:
    ...
    def parseArgs(args):
        ...
        globalArgs.add_argument('--test',
                                ...
                                help='if present, launch the program try to answer all sentences from data/converse/test/ with'
